...
include { gatc_finder                       } from "./nf_modules/gatc_finder/main.nf" addParams(gatc_finder_out: "sites/test/12less/")
include { index_fasta; mapping_fastq        } from "./nf_modules/kallisto/main.nf"    addParams(mapping_fastq_out: "pseudo/test/12less/")
include { multiqc                           } from "./nf_modules/multiqc/main.nf"     addParams(multiqc_out: "mapping/test/12less/")
